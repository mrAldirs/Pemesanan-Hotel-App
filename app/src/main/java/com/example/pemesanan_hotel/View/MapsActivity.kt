...
import com.example.pemesanan_hotel.databinding.ActivityMapsBinding
    ...
    override fun onClick(v: View?) {
        when(v?.id){
            R.id.btnGo ->{
                ...
                URL =
                    "https://api.mapbox.com/geocoding/v5/mapbox.places/$alm.json?proximity=$lng,$lat&access_token=$MAPBOX_TOKEN&limit=1"
